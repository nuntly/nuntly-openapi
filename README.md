...
Both files are auto-generated from the Elysia API source code and Zod schemas.
...
2. File > Open Collection > Import OpenAPI V3 Spec
3. Select `openapi.yaml`
